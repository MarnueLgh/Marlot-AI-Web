		...
		<div class="footer-links">
			...
			<div class="footer-column">
				...
				<ul class="social-icons">
					<li><a href="https://instagram.com/marlot.ai" class="share-btn" target="_blank" rel="noopener" aria-label="Instagram">
